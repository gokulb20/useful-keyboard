...
struct AppConfig: Codable {
    ...
    var contextDetectionEnabled: Bool = true
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case contextDetectionEnabled = "context_detection_enabled"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        contextDetectionEnabled = (try? c.decode(Bool.self, forKey: .contextDetectionEnabled)) ?? defaults.contextDetectionEnabled
    }
}
