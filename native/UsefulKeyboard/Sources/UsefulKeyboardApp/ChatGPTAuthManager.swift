...
final class ChatGPTAuthManager {
        ...
        try await withCheckedThrowingContinuation { continuation in
            ...
            listener.newConnectionHandler = { connection in
                ...
                connection.receive(minimumIncompleteLength: 1, maximumLength: 8192) { data, _, _, _ in
                    ...
                    Connection: close\r
                    \r
                    <!DOCTYPE html><html><body style="font-family:-apple-system,system-ui;display:flex;justify-content:center;align-items:center;height:100vh;margin:0;background:#1a1a1a;color:#fff"><div style="text-align:center"><h2>Signed in to Useful Keyboard</h2><p>You can close this window.</p></div></body></html>
                    """
                    connection.send(
    ...
    private static let keychainService = "com.usefulkeyboard.app.chatgpt-auth"
