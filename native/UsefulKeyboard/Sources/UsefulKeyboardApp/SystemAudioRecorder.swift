...
final class SystemAudioRecorder: NSObject, SCStreamOutput {
    ...
    func start() async throws {
        ...
        let outputDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("uk-system-audio", isDirectory: true)
    ...
    private func startStream() async throws {
        ...
        try stream.addStreamOutput(self, type: .audio, sampleHandlerQueue: DispatchQueue(label: "com.usefulkeyboard.system-audio"))
