; Custom NSIS template for Useful Keyboard with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Useful Keyboard for portable
...
Function .onInit
  ...
  ${AndIf} ${FileExists} "$INSTDIR\portable"
    ...
    FileRead $1 $2
    FileClose $1
    ${If} $2 == "Useful Keyboard Portable Mode"
      StrCpy $PortableMode 1
    ${OrIf} $2 == ""
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Useful Keyboard Portable Mode"
    FileClose $0
