...
pub fn get_icon_path(theme: AppTheme, state: TrayIconState) -> &'static str {
    match (theme, state) {
        ...
        (AppTheme::Colored, TrayIconState::Idle) => "resources/useful_keyboard.png",
...
fn version_label() -> String {
    if cfg!(debug_assertions) {
        format!("Useful Keyboard v{} (Dev)", env!("CARGO_PKG_VERSION"))
    } else {
        format!("Useful Keyboard v{}", env!("CARGO_PKG_VERSION"))
    }
}
