...
async getProcessingModes() : Promise<Result<ProcessingMode[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_processing_modes") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async getActiveModeId() : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_active_mode_id") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setActiveMode(modeId: string) : Promise<Result<null, string>> {
    try {
...
async createProcessingMode(name: string, description: string, prompt: string) : Promise<Result<ProcessingMode, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("create_processing_mode", { name, description, prompt }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async updateProcessingMode(id: string, name: string, description: string, prompt: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("update_processing_mode", { id, name, description, prompt }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async deleteProcessingMode(id: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("delete_processing_mode", { id }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type ProcessingMode = { id: string; name: string; description: string; prompt: string; is_builtin: boolean }
